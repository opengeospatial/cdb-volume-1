...
In CDB Version 1.1, explicit file name extensions in Requirements were replaced with a generic <ext> to designate that one or more file types are allowed to satisfy that requirement. Notes are also provided to indicate what filename extension (type) was required as specified in CDB Versions 1.0 and 1.1. In CBD Version 1.2, the following file extensions are used:

[cols=",,",]
|=====================================================================================================
|*File Format* |*Versions Currently Supported by CDB* |*CDB Client-device Behavior for Prior Versions*
|*.tif |TIFF 6.0 |Ignores data
|*.rgb |SGI image format 1.0 |Ignores data
|*.jp2 |JPEG 2000 1.0 |Ignores data
|*.flt |OpenFlight 16.0 |Ignores data
|*.shp, *.shx |Shapefile - Esri White Paper, July 98 |Ignores data
|*.dbf, *.dbt |dBASE III+ and above |Ignores data
|*.xml |W3C XML 1.0 |Ignores data
|*.zip |ZIP 6.3.1 |Ignores data
|*.gpkg |OGC geoPackage 1.0 or 1.1|Ignores data
|=====================================================================================================
