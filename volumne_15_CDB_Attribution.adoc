...
== Top-Level CDB Attribute Schema File
...
.CDB attributes
[cols="15e, <25m,<30m,<20m,<10m",width="100%",options="header",align="center"]
|===
|Name | Parent Class Name | Definition | Datatype & Value | Multiplicity
...
| Scalers
| Vector Attributes
| A list of Scaler definitions
|
| 1

| Unit
| Units
| A reference to a unit code
|
| 1..+
...
| Text, Enumeration (Enum), Numeric, or Boolean
| 1
...
| Format
| Value
| The format of the value. NOTE: valid for numeric datatype only.
