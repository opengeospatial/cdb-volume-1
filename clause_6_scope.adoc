...
* RGB: Included in the Gamma Tutorial Section, Volume 10: OGC CDB Implementation Guidance
...
* JPEG: The use of the JPEG 2000 file format is described in Volume 2: OGC CDB Core Model and Physical Structure Annexes, Annex H.
* GeoPackage: The use of GeoPackages and how they are to be structured in defined in Volume 13.
* Shapefile to GeoPackage: The conversion of existing CDB structured shapefiles into CDB structured GeoPackages in defined in Volume 14, Shapefile to GeoPackage Best Practice.

Each of these documents has been annotated to reflect the conventions established by the CDB standard. The Best Practice conventions currently define how TIFF, OpenFlight, RGB, Shapefile and JPEG 2000 formatted files are to be interpreted by CDB-compliant simulator readers. The us of the OGC GeoPackage Standard was added as a normative addition for CDB version 1.2. Additional encoding formats and conventions will be defined for future versions of the CDB standard.
