...
* *GeoPackage*: The normative requirements and conformance classes for the use of GeoPackages in a CDB data store. The GeoPackage content encoding rules documented in Volume 13: OGC CDB - Rules for Structuring a GeoPackage;
...
In addition, a new volume in CDB Version 1.2 defines the Best Practices for conversion of CDB Shapefiles into CDB GeoPackages.
