...
* *GeoPackages*: The normative requirements and conformance classes for correctly structuring GeoPackages for use in a CDB data store. The GeoPackage content encoding rules documented in OGC CDB Optional Extension for Structuring a CDB compliant GeoPackage;
