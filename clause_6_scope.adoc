...
In addition, a new volume in CB Version 1.2 defines the Best Practices for conversion of CDB structured Shapefiles into CDB structured GeoPackages.
...
* For the instancing and attribution of statically positioned point, lineal and polygon 2D/3D culture features: Shapefiles or GeoPackages.
...
Please note that the OGC CDB Standards Working Group will consider developing best practice guidance for using other industry standard formats and encodings, such as OGC CityGML, and OGC InDoorGML.
