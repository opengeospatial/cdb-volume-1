...
The UML diagram comprises three major sections (i.e., attributes, units and scalers). The main properties of the vector attributes’ UML diagram are documented below.

|===
|Name | Definition

| Vector Attributes
| The CDB standard provides a flexible means to tag features with attribution data. Attributes are defined through 3 lists: 1) the attributes themselves, 2) their units, and 3) their scalers.
