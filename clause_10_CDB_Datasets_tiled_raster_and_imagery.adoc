...
|004 |001..254 |*.tif |Composite Material Mixture |Each texel indicates the proportion (between 0.0 and 1.0) of the composite material found in the corresponding material layer. CS2 is the layer number. Corresponds to a 2D grid draped (orthographically) at the water bottom derived from the Subordinate Bathymetry Dataset. This Dataset component follows the center grid conventions.
