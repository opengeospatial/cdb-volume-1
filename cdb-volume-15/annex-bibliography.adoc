...
|4 |Enumeration and Bit Encoded Values for use with Protocols for Distributed Interactive Simulation Applications. |This is document SISO-REF-010. It accompanies IEEE Std 1278.1-1995 and can be obtained from the _Simulation Interoperability Standards Organization_ at *http://www.sisostds.org/*
