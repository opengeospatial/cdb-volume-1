...
|001 |004 |*.tif |Primary Alternate Terrain Elevation |A grid of data representing the Elevation of the surface of the Earth at specified Latitude and Longitude offsets inside each grid element. Stored as 3 subfiles within a single TIFF image.  _Preferred alternate to the 4-channel TIFF option._
