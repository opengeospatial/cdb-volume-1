...
|010 |001 |Albedo Texture | Base texture representing the base color, without any lighting or shading applied. This texture type is distinct from a Diffuse base texture. By default, the base texture is Diffused  (details in section 6.13.1)
