...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/CDB-core/1.1
...
|Internal reference number of this OGC(R) document:        15-113r5
|Version: 1.1
...
|===
|*Copyright notice*
|Copyright (C) 2017, 2018 Open Geospatial Consortium
