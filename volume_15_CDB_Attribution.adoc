...
// [[CDB attribution for tiled vector dataset]]
== CDB attribution for tiled vector dataset
...
<<table_cdb_attributes>> defines components of the above figure.
...
////
(10.1.8) CDB Attributes Metadata (.xsd file)

Kholase section 8

10.1.8.1. Definition of the <Attribute> Element

10.1.8.2. Definition of the <Unit> Element

10.1.8.3. Definition of the <Scaler> Element

10.1.8.4. Example of CDB_Attributes.xml
////
