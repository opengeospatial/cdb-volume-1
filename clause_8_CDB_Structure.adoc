...
This file is used to describe all the CDB attributes that are supported by the CDB standard. A complete listing and description of CDB attributes is provided in Vector_Attributes\CDB_Attributes.xml of this standard. The file is described in Section 5.1.8 of Volume 1: CDB Attributes Metadata.
