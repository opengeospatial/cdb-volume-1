...
- http://opengis.net/cdb/1.1/Lights.xsd[Lights.xsd file for version 1.1]
- http://opengis.net/cdb/1.1/Lights.xsd[Lights.xsd file for version 1.2]
- http://opengis.net/cdb/cdb-1_1_0.zip[Lights.xml file for version 1.1]
- http://opengis.net/cdb/cdb-1_2_0.zip[Lights.xml file for version 1.2]
